  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold font-headline mb-12">Our Plans</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="flex flex-col text-center shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardFooter className="pt-0">
                <Button asChild variant="outline" className="w-full">
                  <Link href="/plans">Read More</Link>
                </Button>
              </CardFooter>
            </Card>
            <Card className="flex flex-col text-center shadow-lg hover:shadow-xl transition-shadow">
            ...
            <Card className="flex flex-col text-center shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="flex-grow">
               ...
               <CardFooter className="pt-0">
                <Button asChild variant="outline" className="w-full">
                  <Link href="/loans">Read More</Link>
                </Button>
              </CardFooter>
            </Card>
          </div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold font-headline mb-12">Gallery</h2>
