...
export default function FixedDepositPage() {
  ...
  return (
    <div className="bg-background">
      {/* Hero Section */}
      <section className="py-20 md:py-32 bg-gradient-to-r from-primary to-blue-700 text-primary-foreground">
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid md:grid-cols-1 gap-12 items-center">
          <div className="text-left">
            ...
            <h2 className="text-3xl font-bold font-headline mb-6">अपनी राशि को मात्र 6 वर्ष 6 महीने में दोगुना करें</h2>
          </div>
        </div>
